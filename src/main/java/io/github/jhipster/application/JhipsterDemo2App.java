...
public class JhipsterDemo2App {

    private static final Logger log = LoggerFactory.getLogger(JhipsterDemo2App.class);

    private final Environment env;

    public JhipsterDemo2App(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterDemo2.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterDemo2App.class);
